        ...
        <li>
            ...
            <div class="dropdown-menu notification-menu large">
                <div class="notification-title">
                    <span class="float-right badge badge-default">3</span> Tasks
                </div>
                    ...
                    <ul>
                        <li>
                            <a href="#" class="clearfix">
                                <figure class="image">
                                    <img src="<?= base_url() ?>/public/assets/img/!sample-user.jpg" alt="Joseph Doe Junior" class="rounded-circle" />
                                </figure>
                        ...
                        <li>
                            <a href="#" class="clearfix">
                                <figure class="image">
                                    <img src="<?= base_url() ?>/public/assets/img/!sample-user.jpg" alt="Joseph Junior" class="rounded-circle" />
                                </figure>
                        ...
                        <li>
                            <a href="#" class="clearfix">
                                <figure class="image">
                                    <img src="<?= base_url() ?>/public/assets/img/!sample-user.jpg" alt="Joe Junior" class="rounded-circle" />
                                </figure>
