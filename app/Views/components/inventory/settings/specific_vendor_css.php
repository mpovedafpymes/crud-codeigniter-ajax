...
<link rel="stylesheet" href="<?= base_url()?>/public/assets/vendor/select2-bootstrap-theme/select2-bootstrap.min.css" />
<link rel="stylesheet" href="<?= base_url()?>/public/assets/vendor/datatables/media/css/dataTables.bootstrap4.css" />

<link rel="stylesheet" href="<?= base_url()?>/public/assets/vendor/pnotify/pnotify.custom.css" />